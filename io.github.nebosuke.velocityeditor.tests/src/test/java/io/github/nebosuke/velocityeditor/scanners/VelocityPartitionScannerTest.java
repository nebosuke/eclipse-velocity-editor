...
class VelocityPartitionScannerTest {
    ...
    class PartitionConstants {
        ...
        @Test
        @DisplayName("SCRIPT_BLOCKが正しい値を持つ")
        void scriptBlockConstant() {
            assertEquals("__script_block", VelocityPartitionScanner.SCRIPT_BLOCK);
        }
    }
    ...
    class PartitionTypesArray {
        ...
        void hasCorrectNumberOfPartitionTypes() {
            assertEquals(4, VelocityPartitionScanner.PARTITION_TYPES.length);
        }
        ...
        @Test
        @DisplayName("SCRIPT_BLOCKを含む")
        void containsScriptBlock() {
            assertArrayContains(VelocityPartitionScanner.PARTITION_TYPES, VelocityPartitionScanner.SCRIPT_BLOCK);
        }
